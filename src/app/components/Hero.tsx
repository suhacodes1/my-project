  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        <motion.div className="hidden md:absolute left-[220px] top-[20px]" drag>
          <Image
            src={cursor}
            height="170"
            width="170"
        ...
        <motion.div
          className="hidden md:absolute right-[220px] top-[20px]"
          drag
        >
          <Image
            src={lightning}
        ...
        <p className="text-center text-xl max-w-[500px] mx-auto mt-8 text-white/80">
          {" "}
          I am a uni student in my 3rd year of my Software Engineering degree
          and am passionate about full-stack developing.
        </p>
